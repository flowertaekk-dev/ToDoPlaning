...
class Login extends Component {
    ...
    render() {
        ...
        const signUpComponent = <SignUp whenLoginSuccess={this.props.whenLoginSuccess} />
            ...
            <div className='Login'>
                <form onSubmit={this.singInHandler}>
                    ...
                    <div className='btn-container'>
                        ...
                        <button type='button' name='signUpBtn' onClick={this.clickedSignUpHandler}>Sign up</button>
                    </div>
